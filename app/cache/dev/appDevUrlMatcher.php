    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/log')) {
            if (0 === strpos($pathinfo, '/login')) {
                ...
                if ($pathinfo === '/login') {
                    return array (  '_controller' => 'Security\\UserBundle\\Controller\\SecurityController::loginAction',  '_route' => 'fos_user_security_login',);
                }
                ...
                if ($pathinfo === '/login_check') {
                    ...
                    return array (  '_controller' => 'Security\\UserBundle\\Controller\\SecurityController::checkAction',  '_route' => 'fos_user_security_check',);
                }
            ...
            if ($pathinfo === '/logout') {
                return array (  '_controller' => 'Security\\UserBundle\\Controller\\SecurityController::logoutAction',  '_route' => 'fos_user_security_logout',);
            }
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'FOS\\UserBundle\\Controller\\ProfileController::showAction',  '_route' => 'homepage',);
        }
        not_homepage:
