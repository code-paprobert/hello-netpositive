...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'acme.security.authentication_failure_event_listener' => 'getAcme_Security_AuthenticationFailureEventListenerService',
            'acme.security.interactive_login_listener' => 'getAcme_Security_InteractiveLoginListenerService',
            ...
            'security.firewall.map.context.registration_firewall' => 'getSecurity_Firewall_Map_Context_RegistrationFirewallService',
        ...
        $this->aliases = array(
            ...
            'hwi_oauth.user.provider.entity.secure_area' => 'my_user_provider',
            'hwi_oauth.user_checker' => 'security.user_checker.login_firewall',
            'mailer' => 'swiftmailer.mailer.default',
            'security.user_checker.registration_firewall' => 'security.user_checker.login_firewall',
            'security.user_checker.secure_area' => 'security.user_checker.login_firewall',
    ...
    /**
     * Gets the 'acme.security.authentication_failure_event_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Security\UserBundle\EventListener\AuthenticationListener A Security\UserBundle\EventListener\AuthenticationListener instance.
     */
    protected function getAcme_Security_AuthenticationFailureEventListenerService()
    {
        return $this->services['acme.security.authentication_failure_event_listener'] = new \Security\UserBundle\EventListener\AuthenticationListener($this, $this->get('doctrine.orm.default_entity_manager'), NULL);
    }

    /**
     * Gets the 'acme.security.interactive_login_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Security\UserBundle\EventListener\AuthenticationListener A Security\UserBundle\EventListener\AuthenticationListener instance.
     */
    protected function getAcme_Security_InteractiveLoginListenerService()
    {
        return $this->services['acme.security.interactive_login_listener'] = new \Security\UserBundle\EventListener\AuthenticationListener($this, $this->get('doctrine.orm.default_entity_manager'), $this->get('fos_user.user_manager'), array('facebook' => 'facebook_id'), NULL);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Security\UserBundle\Form\RegisterFormType A Security\UserBundle\Form\RegisterFormType instance.
     */
    protected function getApp_Form_RegistrationService()
    {
        return $this->services['app.form.registration'] = new \Security\UserBundle\Form\RegisterFormType($this->get('fos_user.user_manager'), array('facebook' => 'facebook_id'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Security\UserBundle\Security\Core\User\FOSUBUserProvider A Security\UserBundle\Security\Core\User\FOSUBUserProvider instance.
     */
    protected function getApp_User_ProviderService()
    {
        return $this->services['app.user.provider'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('Security\\UserBundle\\Entity\\User');
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('security.authentication.failure', array(0 => 'acme.security.authentication_failure_event_listener', 1 => 'onAuthenticationFailure'), 0);
        $instance->addListenerService('security.interactive_login', array(0 => 'acme.security.interactive_login_listener', 1 => 'onAuthenticationSuccess'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'hello_netpositive', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $d, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/Security/UserBundle/Resources/config/doctrine') => 'Security\\UserBundle\\Entity'));
        ...
        $c->addDriver($a, 'Security\\UserBundle\\Entity');
        $c->addDriver($b, 'FOS\\UserBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('UserBundle' => 'Security\\UserBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0eed103aa15bd08da4ce9a96cad16b99804c74fbd5481b4e7e5ad9cb6d701177');
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Security\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form'] = $this->get('form.factory')->createNamed('fos_user_registration_form', 'registration_form', NULL, array('validation_groups' => array(0 => 'SecurityRegistration')));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Security\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.security.login_manager'] = new \FOS\UserBundle\Security\LoginManager($this->get('security.context'), $this->get('security.user_checker.login_firewall'), $this->get('security.authentication.session_strategy'), $this);
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Security\\UserBundle\\Entity\\User');
    }
    ...
    protected function getHwiOauth_ResourceOwner_FacebookService()
    {
        ...
        return $this->services['hwi_oauth.resource_owner.facebook'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\FacebookResourceOwner($a, $this->get('security.http_utils'), array('client_id' => '1085320454858054', 'client_secret' => '83626f1517c299dfa715cea0ec2f9e3f', 'scope' => 'email', 'paths' => array('email' => 'email'), 'options' => array()), 'facebook', new \HWI\Bundle\OAuthBundle\OAuth\RequestDataStorage\SessionStorage($this->get('session')));
    }
    ...
    {
        $this->services['hwi_oauth.resource_ownermap.secure_area'] = $instance = new \HWI\Bundle\OAuthBundle\Security\Http\ResourceOwnerMap($this->get('security.http_utils'), array(0 => 'facebook'), array('facebook' => '/login/check-facebook'));
    ...
    {
        return $this->services['my_user_provider'] = new \Security\UserBundle\Security\Core\User\FOSUBUserProvider($this->get('fos_user.user_manager'), array('facebook' => 'facebook_id'));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.login_firewall' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/login$'), 'security.firewall.map.context.registration_firewall' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/register'), 'security.firewall.map.context.secure_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
     ...
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance.
     */
    protected function getSecurity_Firewall_Map_Context_RegistrationFirewallService()
    {
        $a = $this->get('security.token_storage');
        $b = $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE);

        return $this->services['security.firewall.map.context.registration_firewall'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username'), 1 => $this->get('security.user.provider.concrete.database_users')), 'registration_firewall', $b, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '56d2d987025fc4.00869461', $b, $this->get('security.authentication.manager')), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'registration_firewall', NULL, NULL, NULL, $b, false));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecureAreaService()
    {
        ...
        $i->setOptions(array('login_path' => '/login', 'default_target_path' => '/profile', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $i->setProviderKey('secure_area');
        ...
        $k->setOptions(array('login_path' => '/login', 'default_target_path' => '/profile', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $k->setProviderKey('secure_area');
        ...
        $m = new \HWI\Bundle\OAuthBundle\Security\Http\Firewall\OAuthListener($a, $f, $g, $d, 'secure_area', $k, $l, array('check_path' => '/login', 'use_forward' => false, 'require_previous_session' => true), $b, $c);
        $m->setResourceOwnerMap($this->get('hwi_oauth.resource_ownermap.secure_area'));
        $m->setCheckPaths(array(0 => '/login/check-facebook'));

        return $this->services['security.firewall.map.context.secure_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username'), 1 => $this->get('security.user.provider.concrete.database_users')), 'secure_area', $b, $c), 2 => $h, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $g, $d, 'secure_area', $i, $j, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => $m, 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '56d2d987025fc4.00869461', $b, $f), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'secure_area', new \HWI\Bundle\OAuthBundle\Security\Http\EntryPoint\OAuthEntryPoint($d, '/login'), NULL, NULL, $b, false));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Security/UserBundle/Resources/views'), 'User');
        $instance->addPath(($this->targetDirs[3].'/src/Security/FacebookBundle/Resources/views'), 'Facebook');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => ($this->targetDirs[3].'/src/Security/UserBundle/Resources/config/validation.yml')));
    ...
    {
        $a = $this->get('security.user_checker.login_firewall');

        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56d2d987025fc4.00869461'), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56d2d987025fc4.00869461'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('fos_user.user_provider.username'), $a, 'secure_area', $this->get('security.encoder_factory'), true), 3 => new \HWI\Bundle\OAuthBundle\Security\Core\Authentication\Provider\OAuthProvider($this->get('my_user_provider'), $this->get('hwi_oauth.resource_ownermap.secure_area'), $a), 4 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56d2d987025fc4.00869461')), true);
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('secure_area', '/logout', 'logout', '_csrf_token', NULL);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'UserBundle' => 'Security\\UserBundle\\UserBundle',
                'FacebookBundle' => 'Security\\FacebookBundle\\FacebookBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'hello_netpositive',
            'database_user' => 'root',
            ...
            'fos_user.firewall_name' => 'secure_area',
            'fos_user.model_manager_name' => NULL,
            'fos_user.model.user.class' => 'Security\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.form.type' => 'registration_form',
            'fos_user.registration.form.validation_groups' => array(
                0 => 'SecurityRegistration',
            ),
